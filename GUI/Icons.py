...
class Icons(object):
    def __init__(self):
        ...
        self.make_icon("ico_alumni", "icons/alumni.png")
        self.make_icon("ico_stock", "icons/stock.png")
        self.make_icon("ico_sale", "icons/sale.png")
        self.make_icon("ico_group", "icons/group.png")
